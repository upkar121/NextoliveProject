...
public class CollapsingImageLayout extends FrameLayout {
    ...
    private int msubSubtitleLeftExpanded;

    private int msubSubtitleTopExpanded;
    ...
    private int msubSubtitleLeftCollapsed;

    private int msubSubtitleTopCollapsed;
    ...
    public CollapsingImageLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        msubSubtitleLeftCollapsed = getResources().getDimensionPixelOffset(R.dimen.sub_subtitle_left_margin_collapsed);
        msubSubtitleTopCollapsed = getResources().getDimensionPixelOffset(R.dimen.sub_subtitle_top_margin_collapsed);
        ...
        for (int i = 0, z = getChildCount(); i < z; i++) {
            ...
            switch (child.getId()) {
                ...
                case R.id.subtitle:
                    ...
                    break;
                case R.id.location_distance:
                    msubSubtitleLeftExpanded = child.getLeft();
                    msubSubtitleTopExpanded = child.getTop();
                    break;
            }
        }
    }
...
//                }
                ...
                if (child.getId() == R.id.location_distance) {

                    int topOffset = (int) ((msubSubtitleTopCollapsed - msubSubtitleTopExpanded) * offsetFactor) - verticalOffset;
                    int leftOffset = (int) ((msubSubtitleLeftCollapsed - msubSubtitleLeftExpanded) * offsetFactor);
                    offsetHelper.setTopAndBottomOffset(topOffset);
                    offsetHelper.setLeftAndRightOffset(leftOffset);
                }
            }
